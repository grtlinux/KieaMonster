package org.tain.working.load.test;
...
public class TestLoadWork {
	...
	private void loadCust() throws Exception {
		if (Boolean.TRUE) {
			this.tbCustRepository.deleteAll();
		}
		if (Boolean.TRUE) {
	...
	private void loadProd() throws Exception {
		if (Boolean.TRUE) {
			this.tbProdRepository.deleteAll();
		}
		if (Boolean.TRUE) {
	...
	private void loadCustProd() throws Exception {
		if (Boolean.TRUE) {
			this.tbCustProdRepository.deleteAll();
		}
		if (Boolean.TRUE) {
